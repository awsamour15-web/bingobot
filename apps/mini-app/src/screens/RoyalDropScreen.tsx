  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .rd-cabinet-grid { height: clamp(200px, 38dvh, 320px); flex: 0 1 auto !important; }
      ...
      {activeTab === 'HISTORY' ? (
        ...
        <div className={`rd-game-content${screenShaking ? ' rd-screen-shake' : ''}`} style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 1, overflow: 'hidden' }}>
          ...
          <div className="rd-cabinet-reel" style={{
            width: '92%', maxWidth: 420, alignSelf: 'center', margin: '8px auto 0',
          ...
          <div className="rd-controls" style={{
            ...
            <div style={{
              textAlign: 'center', marginBottom: 5, color: '#fff', fontSize: 12,
            ...
            <div className="rd-action-row" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <button
                ...
                disabled={!canSpin}
                style={{
                  width: 54, height: 54, borderRadius: '50%', border: 'none', flexShrink: 0,
